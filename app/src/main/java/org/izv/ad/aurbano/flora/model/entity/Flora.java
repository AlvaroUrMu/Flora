package org.izv.ad.aurbano.flora.model.entity;

public class Flora {
    private long id;
    private String nombre, familia, identificacion, altitud, habitat, fitosociologia, biotipo,
        biologia_reproductiva, floracion, fructificacion, expresion_sexual, polinizacion, dispersion,
        numero_cromosomatico, reproduccion_asexual, distribucion, biologia, demografia, amenazas,
        medidas_propuestas;
